<template>
  <div v-show="addresses.length">
    <button class="button is-qtumcash" @click="show = !show">
    ...
    methods: {
      ...
      async onTransaction({address, id}) {
        ...
        if (window.Notification && Notification.permission === 'granted') {
          ...
          let options = {
            body: id,
            icon: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/QtumCash_logo.svg/102px-QtumCash_logo.svg.png',
            data: id,
            tag: 'transaction/' + id
          }
